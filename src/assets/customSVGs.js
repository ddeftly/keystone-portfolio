...
export class KeystoneOutline extends Component {
    ...
    render() {
        return(
            ...
            >
                <svg viewBox="0 0 139.52 105.64" style={{ height: '100%', width: '100%',  ...this.props.style }}>
                    <g
                        style={{
                            stroke: '#FFFFFF',
                            fill: '#424242',
                    ...
                    >
                        <path pose={this.state.rotatePose} class="cls-2" d="M158.59,71a3.71,3.71,0,0,1-3,1.76H78.73c-1.1,0-1.55.78-1,1.73l7.54,13.07c.55,1,1,1.74,1,1.74l1,1.73,19.66,34a3.85,3.85,0,0,1,0,3.47l-7.55,13.07a1.06,1.06,0,0,1-2,0L58.64,74.44l-1-1.73s-.46-.78-1-1.73L49.09,57.91c-.55-.95-.1-1.73,1-1.73H164.58a1.1,1.1,0,0,1,1,1.76Z" transform="translate(-38.24 -55.18)"/>
                        <path pose={this.state.rotatePose} class="cls-2" d="M146.68,89.25c1.1,0,1.55.78,1,1.73l-38.74,67.11a3.85,3.85,0,0,1-3,1.73H90.77a3.85,3.85,0,0,1-3-1.73L39.48,74.44c-.55-1-.1-1.73,1-1.73H55.64a3.85,3.85,0,0,1,3,1.73l38.75,67.12a1.06,1.06,0,0,0,2,0l7.55-13.07,2-3.47L128.6,91a3.85,3.85,0,0,1,3-1.73Z" transform="translate(-38.24 -55.18)"/>
                        <path pose={this.state.rotatePose} class="cls-1" d="M175.52,72.71c1.1,0,1.55.78,1,1.73l-48.29,83.65a3.85,3.85,0,0,1-3,1.73H109.94c-1.1,0-1.55-.78-1-1.73L147.68,91c.55-1,.1-1.73-1-1.73H88.27a3.83,3.83,0,0,1-3-1.74L77.73,74.44c-.55-1-.1-1.73,1-1.73Z" transform="translate(-38.24 -55.18)"/><path class="cls-2" d="M175.52,72.71c1.1,0,1.55.78,1,1.73l-48.29,83.65a3.85,3.85,0,0,1-3,1.73H109.94c-1.1,0-1.55-.78-1-1.73L147.68,91c.55-1,.1-1.73-1-1.73H88.27a3.83,3.83,0,0,1-3-1.74L77.73,74.44c-.55-1-.1-1.73,1-1.73Z" transform="translate(-38.24 -55.18)"/>
                    </g>
                </svg>
            </RotatingDiv>
        )
